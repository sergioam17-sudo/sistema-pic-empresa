                    ...
                    with st.form("form_reporte_muni"):
                        ...
                        if st.form_submit_button("Enviar a Revisión del Referente"):
                            if meta_avanc <= 0:
                                ...
                                # Uso de la función safe_update para evitar errores 429
